...
if (isset($_POST['btn'])) {
    ...
    move_uploaded_file($image['tmp_name'], '../uploads/clients/' . $imageName);
    ...
    try {
        if (strlen($name) < 4) {
            ...
            $addQuery = "INSERT INTO clients VALUES (null , '$name' , '$imageName' , '$age' , '$email' ,'$pass' , '$phone')";
...
<h1 class="text-center fw-bold pb-5 title">Add a Client</h1>
