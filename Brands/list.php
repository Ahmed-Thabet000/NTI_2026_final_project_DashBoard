...
<div style="max-width: 1000px; margin: 120px auto 40px auto; padding: 0 20px;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
        <h2 style="color: #0b132b; font-weight: 600;">Brands List</h2>
        <a href="add.php" style="background: #0b132b; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none;">+ Add New</a>
    </div>
    ...
    <table style="width: 100%; border-collapse: collapse; background: white; box-shadow: 0 4px 6px rgba(0,0,0,0.05); border-radius: 8px; overflow: hidden;">
        ...
        <tr style="border-bottom: 1px solid #e2e8f0;">
            ...
            <td style="padding: 15px;"><?= htmlspecialchars($brand['name']) ?></td>
            <td style="padding: 15px; text-align: center;">
                <a href="edit.php?id=<?= $brand['id'] ?>" title="Edit" style="color: #2563eb; font-size: 18px; margin-right: 15px; text-decoration: none;">
                    <i class="bi bi-pencil-square"></i>
                </a>
                <a href="delete.php?id=<?= $brand['id'] ?>" title="Delete" style="color: #dc2626; font-size: 18px; text-decoration: none;" onclick="return confirm('Are you sure you want to delete this brand?');">
