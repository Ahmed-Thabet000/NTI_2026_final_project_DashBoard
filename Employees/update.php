...
if (isset($_POST['btn'])) {
    ...
    try {
        if (strlen($name) < 4) {
            ...
            $updateQuery = "UPDATE employees SET name = '$name' , phone = '$phone', email = '$email' , pass = '$pass' , age = '$age' , role = '$role' , image = '$image' WHERE id = '$id'";
...
<h1 class="text-center fw-bold pb-5 title">Update an Employee</h1>
